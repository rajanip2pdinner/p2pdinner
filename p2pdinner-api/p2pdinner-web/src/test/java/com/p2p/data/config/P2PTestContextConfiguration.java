...
import com.p2p.domain.vo.UserProfileEntityBuilder;
...
public class P2PTestContextConfiguration {
	...
	public EntityBuilder<UserProfile, String> userProfileEntityBuilder(){
		EntityBuilder<UserProfile, String> userProfileEntityBuilder = new UserProfileEntityBuilder();
		return userProfileEntityBuilder;
	}
