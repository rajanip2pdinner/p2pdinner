...
- (void)getCategoryListItem:(CategoryResponceBlock)categoryResponceBlock{
    ...
    [self execute:@"https://p2pdinner-services.herokuapp.com/api/v1/dinnercategory/view" requestObject:@"" contentType:@"application/json" requestMethod:@"GET" serviceCallBack:^(NSError *error, id response) {
